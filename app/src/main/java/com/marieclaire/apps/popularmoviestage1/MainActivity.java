...
import com.marieclaire.apps.popularmoviestage1.Model.MovieAdapter;
import com.marieclaire.apps.popularmoviestage1.Util.JsonUtils;
import com.marieclaire.apps.popularmoviestage1.Util.NetworkUtils;
...
import static com.marieclaire.apps.popularmoviestage1.DetailActivity.INTENT_EXTRA_MOVIE;
...
public class MainActivity extends AppCompatActivity implements
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        else if(id==R.id.action_popular)
        {
            ...
            //URL moviesRequestUrl = NetworkUtils.buildUrl(MainActivity.this, pref_order_by_key);
           // try {
